...
import com.hb.project4.shapes.PentagonShape;
import com.hb.project4.shapes.TriangleShape;

public class TriangleTool extends SuperTool{

	public TriangleTool(DrawJPanel j) {
		super(j);
	...
	public void mousePressedAction(MouseEvent mouseEvent) {
		...
		this.setOperateShape(new TriangleShape());
