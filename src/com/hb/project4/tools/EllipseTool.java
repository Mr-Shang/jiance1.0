...
import com.hb.project4.shapes.EllipseShape;

public class EllipseTool extends SuperTool{

	public EllipseTool(DrawJPanel j) {
		super(j);
	...
	public void mousePressedAction(MouseEvent mouseEvent) {
		...
		this.setOperateShape(new EllipseShape());
