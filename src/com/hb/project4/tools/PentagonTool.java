...
import com.hb.project4.shapes.CircleShape;
import com.hb.project4.shapes.PentagonShape;

public class PentagonTool extends SuperTool{

	public PentagonTool(DrawJPanel j) {
		super(j);
	...
	public void mousePressedAction(MouseEvent mouseEvent) {
		...
		this.setOperateShape(new PentagonShape());
