...
import com.hb.project4.shapes.PentacleShape;
import com.hb.project4.shapes.RectangleShape;

public class PentacleTool extends SuperTool{

	public PentacleTool(DrawJPanel j) {
		super(j);
	...
	public void mousePressedAction(MouseEvent mouseEvent) {
		...
		this.setOperateShape(new PentacleShape());
